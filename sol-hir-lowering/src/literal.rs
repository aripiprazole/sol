...
use sol_hir::source::literal::Literal;

use super::*;

impl HirLowering<'_, '_> {
    pub fn literal(&mut self, tree: sol_syntax::Literal) -> Literal {
        use sol_syntax::anon_unions::Char_F32_F64_I128_I16_I64_I8_Nat_String_U1_U128_U16_U32_U64_U8::*;
