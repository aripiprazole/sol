...
use sol_diagnostic::Offset;
use sol_hir::source::HirSource;
...
pub struct ThirDiagnostic {
    pub id: sol_diagnostic::ErrorId,
    pub location: ThirLocation,
    pub message: Vec<sol_diagnostic::ErrorText>,
}

impl sol_diagnostic::Diagnostic for ThirDiagnostic {
    type TextRange = ThirLocation;

    const KIND: sol_diagnostic::ErrorKind = sol_diagnostic::ErrorKind::TypeError;

    fn error_id(&self) -> sol_diagnostic::ErrorId {
        self.id
    }
...
impl sol_diagnostic::TextRange for ThirLocation {
...
pub struct Reference {
    pub base: sol_hir::solver::Reference,
...
pub mod expr {
    ...
    /// An extension trait for [`sol_hir::expr::Expr`].
    ...
    pub struct ThirCallExpr {
        pub kind: sol_hir::source::expr::CallKind,
        pub callee: Callee,
