...
///
/// `sol_eyre::Result` may be used with one *or* two type parameters.
///
/// ```rust
/// use sol_eyre::Result;
///
...
/// `sol_eyre::Report` may be downcast to `D` **or** to `E`.
///
