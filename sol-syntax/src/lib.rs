...
/// Represents a Sol program that has been parsed into a syntax tree. This is the main entry
/// point for interacting with the Sol syntax tree. It is created by calling the `parse` method
/// on a `SourceFile`.
#[salsa::interned]
pub struct Source {
...
#[salsa::tracked]
pub fn parse(db: &dyn ParseDb, program: sol_vfs::SourceFile) -> Source {
...
/// once for each program.
#[salsa::tracked]
pub fn imp_parse(db: &dyn ParseDb, program: sol_vfs::SourceFile) -> Source {
...
/// Represents a Sol syntax tree. This is a wrapper around a tree-sitter syntax tree that
